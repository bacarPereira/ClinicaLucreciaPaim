...
class RecomendacoesAdapeter(
    ...
    private val recomendacoes: List<RecomendacaoEntity>
) : RecyclerView.Adapter<RecomendacoesAdapeter.MyViewHolder>() {
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun mudarDados() {
            ...
            val adapterConfAtualidade = RecomendacoesAdapeterSub(context, activity)
