...
class MainActivity : AppCompatActivity() {
    ...
    private fun salvarGestante(gestanteViewModel: GestanteViewModel) {
        ...
        gestanteViewModel.inserir(GestanteEntity(0, nomes.get(5),bi.get(5), pais,peso.get(0),altura.get(0),sexo.get(0),grupo_sanguineo.get(1),raca.get(0),provincia.get(0),bairros.get(0),rua.get(0),municipios.get(0),telefone.get(5),email.get(5),dataNascimento.get(1),senha,n_ordem.get(1),fotos_gestantes.get(5),medicos.get(1)))
        gestanteViewModel.inserir(GestanteEntity(0, nomes.get(6),bi.get(6), pais,peso.get(1),altura.get(1),sexo.get(0),grupo_sanguineo.get(2),raca.get(0),provincia.get(0),bairros.get(1),rua.get(1),municipios.get(1),telefone.get(6),email.get(6),dataNascimento.get(2),senha,n_ordem.get(1),fotos_gestantes.get(6),medicos.get(1)))
        gestanteViewModel.inserir(GestanteEntity(0, nomes.get(7),bi.get(7), pais,peso.get(2),altura.get(2),sexo.get(0),grupo_sanguineo.get(3),raca.get(0),provincia.get(0),bairros.get(2),rua.get(2),municipios.get(2),telefone.get(7),email.get(7),dataNascimento.get(3),senha,n_ordem.get(1),fotos_gestantes.get(7),medicos.get(1)))
        gestanteViewModel.inserir(GestanteEntity(0, nomes.get(8),bi.get(8), pais,peso.get(3),altura.get(3),sexo.get(0),grupo_sanguineo.get(0),raca.get(0),provincia.get(0),bairros.get(3),rua.get(3),municipios.get(3),telefone.get(8),email.get(8),dataNascimento.get(0),senha,n_ordem.get(1),fotos_gestantes.get(8),medicos.get(1)))
        gestanteViewModel.inserir(GestanteEntity(0, nomes.get(9),bi.get(9), pais,peso.get(4),altura.get(4),sexo.get(0),grupo_sanguineo.get(1),raca.get(0),provincia.get(0),bairros.get(4),rua.get(4),municipios.get(4),telefone.get(9),email.get(9),dataNascimento.get(1),senha,n_ordem.get(1),fotos_gestantes.get(9),medicos.get(1)))

        gestanteViewModel.inserir(GestanteEntity(0, nomes.get(10),bi.get(10), pais,peso.get(0),altura.get(0),sexo.get(0),grupo_sanguineo.get(2),raca.get(0),provincia.get(0),bairros.get(0),rua.get(0),municipios.get(0),telefone.get(10),email.get(10),dataNascimento.get(2),senha,n_ordem.get(2),fotos_gestantes.get(10),medicos.get(2)))
        gestanteViewModel.inserir(GestanteEntity(0, nomes.get(11),bi.get(11), pais,peso.get(1),altura.get(1),sexo.get(0),grupo_sanguineo.get(3),raca.get(0),provincia.get(0),bairros.get(1),rua.get(1),municipios.get(1),telefone.get(11),email.get(11),dataNascimento.get(3),senha,n_ordem.get(2),fotos_gestantes.get(11),medicos.get(2)))
        gestanteViewModel.inserir(GestanteEntity(0, nomes.get(12),bi.get(12), pais,peso.get(2),altura.get(2),sexo.get(0),grupo_sanguineo.get(0),raca.get(0),provincia.get(0),bairros.get(2),rua.get(2),municipios.get(2),telefone.get(12),email.get(12),dataNascimento.get(0),senha,n_ordem.get(2),fotos_gestantes.get(12),medicos.get(2)))
        gestanteViewModel.inserir(GestanteEntity(0, nomes.get(13),bi.get(13), pais,peso.get(3),altura.get(3),sexo.get(0),grupo_sanguineo.get(1),raca.get(0),provincia.get(0),bairros.get(3),rua.get(3),municipios.get(3),telefone.get(13),email.get(13),dataNascimento.get(1),senha,n_ordem.get(2),fotos_gestantes.get(13),medicos.get(2)))
        gestanteViewModel.inserir(GestanteEntity(0, nomes.get(14),bi.get(14), pais,peso.get(4),altura.get(4),sexo.get(0),grupo_sanguineo.get(2),raca.get(0),provincia.get(0),bairros.get(4),rua.get(4),municipios.get(4),telefone.get(14),email.get(14),dataNascimento.get(2),senha,n_ordem.get(2),fotos_gestantes.get(14),medicos.get(2)))
    }

    private fun salvarCartaoGestante(cartaoGestanteViewModel: CartaoGestanteViewModel) {

        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(0) , idade.get(0), estado_civil.get(0),habilidade_literaria.get(0), parceiros.get(0),residencia.get(0),ponto_ref.get(0),grupo_sanguineo.get(0),telefone.get(0),"Não","Diabetes Mellitus", telefone_emergencia.get(0),"3","2","0","2","0",fotos_gestantes.get(0)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(1) , idade.get(1), estado_civil.get(1),habilidade_literaria.get(1), parceiros.get(1),residencia.get(1),ponto_ref.get(1),grupo_sanguineo.get(1),telefone.get(1),"Sim","Não", telefone_emergencia.get(1),"2","1","0","1","0",fotos_gestantes.get(1)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(2) , idade.get(2), estado_civil.get(0),habilidade_literaria.get(1), parceiros.get(2),residencia.get(2),ponto_ref.get(2),grupo_sanguineo.get(2),telefone.get(2),"Não","HIV", telefone_emergencia.get(2),"3","2","0","2","0",fotos_gestantes.get(2)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(3) , idade.get(3), estado_civil.get(1),habilidade_literaria.get(1), parceiros.get(3),residencia.get(3),ponto_ref.get(3),grupo_sanguineo.get(3),telefone.get(3),"Sim","Não", telefone_emergencia.get(3),"4","3","0","3","0",fotos_gestantes.get(3)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(4) , idade.get(0), estado_civil.get(0),habilidade_literaria.get(1), parceiros.get(4),residencia.get(4),ponto_ref.get(4),grupo_sanguineo.get(0),telefone.get(4),"Não","Não", telefone_emergencia.get(4),"1","0","0","0","0",fotos_gestantes.get(4)))

        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(5) , idade.get(1), estado_civil.get(1),habilidade_literaria.get(0), parceiros.get(5),residencia.get(0),ponto_ref.get(0),grupo_sanguineo.get(1),telefone.get(5), "Sim","Diabetes Mellitus",telefone_emergencia.get(0),"3","2","0","2","0",fotos_gestantes.get(5)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(6) , idade.get(2), estado_civil.get(0),habilidade_literaria.get(0), parceiros.get(6),residencia.get(1),ponto_ref.get(1),grupo_sanguineo.get(2),telefone.get(6),"Não","Cancer", telefone_emergencia.get(1),"2","1","0","1","0",fotos_gestantes.get(6)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(7) , idade.get(3), estado_civil.get(1),habilidade_literaria.get(0), parceiros.get(7),residencia.get(2),ponto_ref.get(2),grupo_sanguineo.get(3),telefone.get(7),"Sim","Hepatite", telefone_emergencia.get(2),"3","2","0","2","0",fotos_gestantes.get(7)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(8) , idade.get(0), estado_civil.get(0),habilidade_literaria.get(1), parceiros.get(8),residencia.get(3),ponto_ref.get(3),grupo_sanguineo.get(0),telefone.get(8),"Não","Não", telefone_emergencia.get(3),"4","3","0","3","0",fotos_gestantes.get(8)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(9) , idade.get(1), estado_civil.get(1),habilidade_literaria.get(1), parceiros.get(9),residencia.get(4),ponto_ref.get(4),grupo_sanguineo.get(1),telefone.get(9),"Sim","Cancer", telefone_emergencia.get(4),"1","0","0","0","0",fotos_gestantes.get(9)))

        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(10) , idade.get(2), estado_civil.get(0),habilidade_literaria.get(1), parceiros.get(10),residencia.get(0),ponto_ref.get(0),grupo_sanguineo.get(2),telefone.get(10),"Não","HIV", telefone_emergencia.get(0),"1","0","0","0","0",fotos_gestantes.get(10)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(11) , idade.get(3), estado_civil.get(1),habilidade_literaria.get(1), parceiros.get(11),residencia.get(1),ponto_ref.get(1),grupo_sanguineo.get(3),telefone.get(11),"Sim", "Diabetes Mellitus",telefone_emergencia.get(1),"4","3","0","3","0",fotos_gestantes.get(11)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(12) , idade.get(0), estado_civil.get(0),habilidade_literaria.get(0), parceiros.get(12),residencia.get(2),ponto_ref.get(2),grupo_sanguineo.get(0),telefone.get(12),"Não","Hepatite", telefone_emergencia.get(2),"3","2","0","2","0",fotos_gestantes.get(12)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(13) , idade.get(1), estado_civil.get(1),habilidade_literaria.get(1), parceiros.get(13),residencia.get(3),ponto_ref.get(3),grupo_sanguineo.get(1),telefone.get(13),"Sim", "Não",telefone_emergencia.get(3),"2","1","0","1","0",fotos_gestantes.get(13)))
        cartaoGestanteViewModel.inserir(CartaoGestanteEntity(0,unidade_sanitaria,nomes.get(14) , idade.get(2), estado_civil.get(0),habilidade_literaria.get(0), parceiros.get(14),residencia.get(4),ponto_ref.get(4),grupo_sanguineo.get(2),telefone.get(14),"Não", "Diabetes Mellitus",telefone_emergencia.get(4),"3","2","0","2","0",fotos_gestantes.get(14)))
    }
